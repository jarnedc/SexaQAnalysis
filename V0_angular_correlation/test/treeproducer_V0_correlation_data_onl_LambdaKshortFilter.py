...
#for this special check of overlaps between angular correlation of strange particles only keep the filter that gets rid of the overlap
...
process.TFileService = cms.Service('TFileService',
    fileName = cms.string('ZeroBias_LambdaKshortFilter_only_single_file.root')
)
...
process.out = cms.OutputModule("PoolOutputModule",
  ...
  fileName = cms.untracked.string("V0_correlation_ZeroBias_single_file.root"),
