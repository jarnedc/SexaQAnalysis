...
tupleOfFiles=tuple(['file:///pnfs/iihe/cms/store/user/jdeclerc/MinBias_TuneCUETP8M1_13TeV-pythia8/MinBias_asData_150718/180715_164309/0000/V0_correlation_ZeroBias_single_file_' + x + '.root' for x in rangeOfStrings])
...
process.TFileService = cms.Service('TFileService',
    fileName = cms.string('analysed_MinBias_asData_LambdaKshort_correlation_only_LambdaKshortFilter.root')
)
