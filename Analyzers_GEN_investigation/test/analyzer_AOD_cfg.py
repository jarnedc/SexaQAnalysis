...
process.source = cms.Source("PoolSource",
	...
	#	*tupleOfFiles #the * is to unpack the tuple of filenames
      ...
      'file:///pnfs/iihe/cms/store/user/jdeclerc/crmc_Sexaq/GENSIM/Sexaquark_13TeV_trial4/sexaq_GENSIM_1_17.root'
      #'file:///pnfs/iihe/cms/store/user/jdeclerc/crmc_Sexaq/Step1/Sexaquark_13TeV_trial4_NO_PU/SUS-RunIISummer16DR80Premix-00068_step1_1_4.root'
      #'file:///pnfs/iihe/cms/store/user/jdeclerc/crmc_Sexaq/Step2/Sexaquark_13TeV_trial4_NO_PU/SUS-RunIISummer16DR80Premix-00068_1_4.root'
      #'file:///pnfs/iihe/cms/store/user/jdeclerc/crmc_Sexaq/Skimmed/Sexaquark_13TeV_trial4_NO_PU/events_skimmed_MC_Sexaq_1_4.root'
...
# Analyzer
process.load("SexaQAnalysis.Analyzers_GEN_investigation.Analyzer_GEN_Sexaq_cfi") 
process.Analyzer_GEN_Sexaq.isData = cms.untracked.bool(True) ##############SET BACK TO TRUE################

process.p = cms.Path(
  process.Analyzer_GEN_Sexaq
)


# Output
process.TFileService = cms.Service('TFileService',
    fileName = cms.string('analyzed_sexaq_GENSIM_1_17.root')
#    fileName = cms.string('analyzed_sexaq_Step1_1_1.root')
#    fileName = cms.string('analyzed_sexaq_Step2_1_1.root')
#    fileName = cms.string('analyzed_sexaq_Skimmed_1_1.root')
)
