...
#SSEEDD = 1 + 1234 
#process.RandomNumberGeneratorService.generator.initialSeed = int(SSEEDD)
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Configuration/GenProduction/python/SingleNeutronPt1000_pythia8_cfi.py nevts:481'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:LambdaGun_GENSIM_IIDD.root'),
