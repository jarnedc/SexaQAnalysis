...
process.Analyzer_V0Fitter.associators = ['quickTrackAssociatorByHits']

process.p = cms.Path(
  #process.simHitTPAssocProducer*process.trackAssociatorByHits*process.Analyzer_V0Fitter
  process.tpClusterProducer *process.quickTrackAssociatorByHits*process.Analyzer_V0Fitter
)
