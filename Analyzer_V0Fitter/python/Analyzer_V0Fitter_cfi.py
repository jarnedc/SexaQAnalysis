...
Analyzer_V0Fitter = cms.EDAnalyzer('Analyzer_V0Fitter',
    ...
    TrackingParticleCollection = cms.InputTag("mix","MergedTrackTruth","HLT"),
    trackAssociatorByHits = cms.InputTag("simHitTPAssocProducer","","RECO"),
