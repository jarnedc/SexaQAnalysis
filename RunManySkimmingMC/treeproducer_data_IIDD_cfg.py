...
process.source = cms.Source("PoolSource",
   fileNames = cms.untracked.vstring( 
    'dcap://maite.iihe.ac.be/pnfs/iihe/cms/store/user/jdeclerc/crmc_Sexaq/Step2/Sexaquark_13TeV_trial7_Vtx_smeared/SUS-RunIISummer16DR80Premix-00068_IIDD.root',
   ),
...
#  fileName = cms.untracked.string("events_skimmed_2017_trialC.root"),
  fileName = cms.untracked.string("events_skimmed_MC_Sexaq_IIDD.root"),
