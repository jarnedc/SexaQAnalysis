...
tupleOfFiles2=tuple(['file:///pnfs/iihe/cms/store/user/jdeclerc/SingleMuon/SingleMuon_multicrab/180731_134343/0000/events_skimmed_' + x + '.root' for x in rangeOfStringsD] )
tupleOfFiles3=tuple(['file:///pnfs/iihe/cms/store/user/jdeclerc/SingleMuon/SingleMuon_multicrab/180731_134430/0000/events_skimmed_' + x + '.root' for x in rangeOfStringsE] )
tupleOfFiles4=tuple(['file:///pnfs/iihe/cms/store/user/jdeclerc/SingleMuon/SingleMuon_multicrab/180731_134500/0000/events_skimmed_' + x + '.root' for x in rangeOfStringsF] )
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring(
		*tupleOfFiles4 #the * is to unpack the tuple of filenames
...
process.TFileService = cms.Service('TFileService',
    fileName = cms.string('analysed_SingleMuon_LambdaKshort_correlation_allFilters_2016data_multicrab_runF.root')
)
