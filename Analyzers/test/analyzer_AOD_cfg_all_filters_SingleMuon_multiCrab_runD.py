...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring(
		*tupleOfFiles2 #the * is to unpack the tuple of filenames
...
process.TFileService = cms.Service('TFileService',
    fileName = cms.string('analysed_SingleMuon_LambdaKshort_correlation_allFilters_2016data_multicrab_runD.root')
)
