...
#ZeroBias only first filter ran
rangeOfStrings=[str(i) for i in range(1,500)]
tupleOfFiles=tuple(['file:///pnfs/iihe/cms/store/user/jdeclerc/ZeroBias/ZeroBias_Run2016G/180703_144015/0000/V0_correlation_ZeroBias_single_file_' + x + '.root' for x in rangeOfStrings])
...
process.TFileService = cms.Service('TFileService',
    fileName = cms.string('analysed_ZeroBias_LambdaKshort_correlation_only_LambdaKshortFilter.root')
)
