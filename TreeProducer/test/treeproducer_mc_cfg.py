...
#     'file:///user/lowette/SexaQ/Run2016H_SingleMuon_AOD_07Aug17-v1_10000_F068EC7F-FB96-E711-96FF-7845C4FC3BFF.root'
     'file:///user/jdeclerc/Analysis/dataSamples/WJetsMC/023963AD-CBBE-E611-AC12-D4AE526A048B.root'
    )
)
...
process.genParticlePlusGEANT = cms.EDProducer("GenPlusSimParticleProducer",
  ...
  particleTypes = cms.vstring("p+","pi+"),
...
#process.tree.lambdaKshortCollection = cms.InputTag("lambdaKshortVertexFilter")
